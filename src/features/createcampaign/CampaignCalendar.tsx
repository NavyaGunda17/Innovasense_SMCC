...
const CampaignCalendar = forwardRef<CampaignCalendarHandle, CampaignCalendarProps>(
...
useEffect(() => {
  if (camapaignState?.startDate) {
    const formattedDate = new Date(camapaignState.startDate).toISOString().split("T")[0]; // "2025-07-29"
  ...
  return (
    <>
         <Box sx={{ display:"flex",flexDirection:"row",gap:2,alignItems:"center"}}>
                     ...
                     Campaign <br />Calendar
                    </Typography>
                    <img src={loader} style={{width:"200px"}} />
                    </Box>

      <Box className="campaign-detail-rectangle" >
